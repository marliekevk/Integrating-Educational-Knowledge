...
for s=2:31 % there's no data for participant 1
    ...
    order = find([con_recall.curiosity] == 2);
    new_struct = con_recall(order);
    con_cur2 = length(find(strcmp({new_struct.rec}, 'Hit')==1))/(length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1)));
    con_cur2_tr = length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1));
    order = find([con_recall.curiosity] == 3);
    new_struct = con_recall(order);
    con_cur3 = length(find(strcmp({new_struct.rec}, 'Hit')==1))/(length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1)));
    con_cur3_tr = length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1));
    ...
    for i=1:length(new_struct)
        ...
        if new_struct(i).congruency == 1
            ...
            pic_desc_con{i,3} = new_struct(i).curiosity;
    ...
    % determine curiosity and reactivation effects on memory
    order = find([inc_recall.curiosity] == 2);
    new_struct = inc_recall(order);
    inc_cur2 = length(find(strcmp({new_struct.rec}, 'Hit')==1))/(length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1)));
    inc_cur2_tr = length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1));
    order = find([inc_recall.curiosity] == 3);
    new_struct = inc_recall(order);
    inc_cur3 = length(find(strcmp({new_struct.rec}, 'Hit')==1))/(length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1)));
    inc_cur3_tr = length(find(strcmp({new_struct.rec}, 'Hit')==1))+ length(find(strcmp({new_struct.rec}, 'Miss')==1));
    ...
    for i=1:length(new_struct)
        ...
        if new_struct(i).congruency == 2
            ...
            pic_desc_inc{i,3} = new_struct(i).curiosity;
    ...
    if con_hits > 9 && inc_hits > 9
        outcomes(s,:) = [s, con_ABret,con_ABret_RT, inc_ABret, inc_ABret_RT, ...
            con_hits, con_rec, con_dprime, con_FA, con_conf, con_RT, con_cur2, con_cur3, con_reac1, con_reac2, con_reac3, con_cur2_tr, con_cur3_tr, con_reac1_tr, con_reac2_tr, con_reac3_tr,con_picrec, con_picconf, con_picRT, ...
...
col_header={'s_nr','con_ABret','con_ABret_RT','inc_ABret','inc_ABret_RT','con_hits','con_rec','con_dprime','con_fa','con_conf','con_RT','con_cur2','con_cur3','con_reac1','con_reac2','con_reac3','con_cur2_tr','con_cur3_tr','con_reac1_tr','con_reac2_tr','con_reac3_tr','con_picrec_tr','con_picconf','con_picRT', ...
    'inc_hits','inc_rec','inc_dprime','inc_fa','inc_conf','inc_RT','inc_cur2','inc_cur3','inc_reac1','inc_reac2','inc_reac3','inc_cur2_tr','inc_cur3_tr','inc_reac1_tr','inc_reac2_tr','inc_reac3_tr','inc_picrec','inc_picconf','inc_picRT'};
xlswrite('outcomes_con.xlsx',col_header,1,'A1');
xlswrite('outcomes_con.xlsx',outcomes,1,'A2');